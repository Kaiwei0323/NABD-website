...
const QC01WReflashQCLinux = () => {
  ...
  const WGET_CMD = 'wget -c https://www.inventecna.com/files/qcs6490/Files/QC01W/QCLinux/v0.2.6.2.zip'
  ...
  return (
    ...
    >
      ...
      <div className="dev-sop-block">
        <h3 className="dev-sop-block-title">Download QCLinux image package</h3>
        <p className="dev-sop-block-text">
          Download the QCLinux image package to your host computer, then extract it.
        </p>
        <ol className="dev-sop-steps">
          <li>
...
export default QC01WReflashQCLinux
