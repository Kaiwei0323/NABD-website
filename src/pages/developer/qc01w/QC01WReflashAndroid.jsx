...
const QC01WReflashAndroid = () => {
  ...
  const WGET_CMD =
    'wget -c https://www.inventecna.com/files/qcs6490/Files/QC01W/QCAndroid/la-32-v0108-ng.tar.gz'
  ...
  return (
    <QC01WReflashTemplate title="Android">
      ...
      <div className="dev-sop-block">
        ...
        <p className="dev-sop-block-text">
          Download the Android image package to your host computer, then extract it.
        </p>
        <ol className="dev-sop-steps">
          <li>
