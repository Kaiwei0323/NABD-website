  ...
  const config = useMemo(() => {
    ...
    const configs = {
      'jp-6-2-ota': {
        ...
        packageDescription:
          'Download the OTA package via HTTPS. Then follow the manual below to refresh the image over Ethernet.',
        wgetCmd: 'wget -c https://www.inventecna.com/files/orin/Files/ucon/JP6.2/UC_dev_6.2_V03_OTA.zip',
      ...
      'jp-6-2-usb': {
        ...
        packageDescription:
          'Download the USB package via HTTPS. Then follow the manual below to refresh the image.',
        wgetCmd: 'wget -c https://www.inventecna.com/files/orin/Files/ucon/JP6.2/UC_dev_6.2_V03_USB.zip',
